...
for i in range(len(test_data1)):
  nedbor.legg_til_en(test_data1[i])
...
test_data4_1 = "2.4"
nedbor.legg_til_en(test_data4_1)
try:
...
test_data4_2 = "2.4.0"
nedbor.legg_til_en(test_data4_2)
print("Dag:",nedbor.get_liste()[-1].get_ukedag(),"\tNedbør:",nedbor.get_liste()[-1].get_mm(),"mm")

print('4.3 Boolean: False')
test_data4_3 = False
nedbor.legg_til_en(test_data4_3)
print("Dag:",nedbor.get_liste()[-1].get_ukedag(),"\tNedbør:",nedbor.get_liste()[-1].get_mm(),"mm")
