  ...
  def legg_til_en(self,mm:float) -> None:
    ...
    if type(mm) == str or type(mm) == float or type(mm) == int:
      try:
        mm = float(mm)
        if mm < 0:
          print("Nedbørsmengde må angis som et positivt tall.")
        elif mm > 250:
          print("Største tillatte verdi er 250 mm. Hvis nedbøren virkelig er høyere: kontakt programmereren for redigering av metoden.")
        else:
          # Ukedager
        ...
        print("Tekstverdien kan ikke gjøres om til tall. Skriv inn et ekte tall.")
    else:
      print("Nedbørsmengden må være et tall av typen int eller float.")
