...
MENY_XSTART = 20
MENY_YSTART = 20
MENY_YAVSTAND = 300  # y-avstand for hvert element
...
def tegnMatplotlibDiagram(aarstall, diagramtype):
  ...
  bilde = pg.transform.scale(bilde, (VINDU_BREDDE-200, VINDU_HOYDE-100))
  return bilde
...
meny.append(
  Nedtrekksliste(
    MENY_XSTART, MENY_YSTART, ["2017", "2021"], 190
  )
)

meny.append(
  Nedtrekksliste(
    MENY_XSTART + MENY_YAVSTAND, MENY_YSTART, ["Tabell","Søyle","Sektor"], 190
  )
)

# OK-knapp
meny.append(Knapp(MENY_XSTART + 2 * MENY_YAVSTAND, MENY_YSTART, "OK",200))
...
while True:
  ...
  if diagramBilde:
    VINDU.blit(diagramBilde, (20, 100), pg.Rect(0, 0, VINDU_BREDDE-200, VINDU_HOYDE-100))
